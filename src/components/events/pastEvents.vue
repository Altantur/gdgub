...
export default {
    ...
    created(){
        fetch('https://cors-anywhere.herokuapp.com/https://api.meetup.com/2/events?group_urlname='+MeetupAPI.urlname+'&desc=true&photo-host=public&page=8&status=past').then(data=>data.json()).then(res=>{
            if(res.length>0){
